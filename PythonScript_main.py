"""
   ...
   Identification process and experiment design for the Arcan experimental test using Abaqus
    ...
    Run by writting on the command line: "python PythonScript_main.py"
"""
...
available_test_configs = '0','22.5', '45','67.5', '90' # Available FEA results in terms of load and material direction
test_config = 'Load_0_MatDir_0' #Load_90_MatDir_0 , Load_67.5_MatDir_0, Load_45_MatDir_0, Load_22.5_MatDir_0, Load_0_MatDir_0,...
...
run_AbaqustoMatchID = 'no'              #yes, no | runs the Abaqus to MatchID script to prepare results for 
                                        #virtual experiment
run_FEA_ExtractResults = 'no'           #yes, no | extracts the FEA results
run_FEA_princStrainStress_plots = 'yes'  #yes, no | plots the FEA principal strains and stresses graphs
